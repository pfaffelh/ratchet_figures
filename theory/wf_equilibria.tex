...
selection $w_k = (1-\alpha)^k$ ($0<\alpha<1$) and Poisson mutation at rate
...
$w_k\,\Poi(\nu;k)=(1-\alpha)^k e^{-\nu}\nu^k/k!\propto(\nu(1-\alpha))^k/k!$,
i.e.~$w_k=(1-\alpha)^k$ is an exponential tilt of Poisson and merely rescales
its parameter by $1-\alpha$ (equivalently, exponential selection with
$\alpha'=-\ln(1-\alpha)$).
...
\[
  ...
  = M_\mu\bigl(\Poi(\theta_{\mathrm{eq}}(1-\alpha))\bigr)
  = \Poi\bigl(\theta_{\mathrm{eq}}\,(1-\alpha)+\mu\bigr).
\]
The fixed-point equation
$\theta_{\mathrm{eq}}=\theta_{\mathrm{eq}}\,(1-\alpha)+\mu$ gives
\begin{equation}\label{eq:thetaA}
  \boxed{\;\theta_{\mathrm{eq}}^{(A)}\;=\;\frac{\mu}{\alpha}\;.}
\end{equation}
...
\[
  ...
  = \Poi\bigl((\theta_{\mathrm{eq}}+\lambda)\,(1-\alpha)\bigr),
\]
so $\theta_{\mathrm{eq}}=(\theta_{\mathrm{eq}}+\lambda)(1-\alpha)$ yields
$\theta_{\mathrm{eq}}\,\alpha=\lambda(1-\alpha)$ and hence
\begin{equation}\label{eq:thetaB}
  \boxed{\;\theta_{\mathrm{eq}}^{(B)}
        \;=\;\frac{\lambda\,(1-\alpha)}{\alpha}\;.}
\end{equation}
